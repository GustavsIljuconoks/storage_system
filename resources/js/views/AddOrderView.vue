            ...
            <div class="mt-6 overflow-auto relative">
                <table class="min-w-full border-separate border-spacing-y-2">
                    ...
                    <tr>
                        ...
                        <td>
                            <Dropdown
                                :menuItems="manufacturers"
                                @selected="handleManufacturerSelect"
                            />
                        </td>
                        ...
                        <td class="flex flex-col p-4 justify-end text-right text-sm font-medium">
                            <button @click.prevent="makeOrder" type="submit" class="shadow-md bg-green-600 hover:bg-green-800 p-3 px-6 rounded text-white text-center">
                                Make order
                            </button>
                        </td>
                    </tr>
...
import { onMounted, ref } from 'vue'
    ...
    const handleProductSelect = (product: Option) => {
        ...
        getSelectedItemId(product.id, 'http://127.0.0.1:8000/api/get-manufacturer', manufacturers);
    }
    ...
    const makeOrder = async () => {
        await axios.post('http://127.0.0.1:8000/api/make-order', {
            "userId": userId,
