                    ...
                    <ul class="bg-blue-900/20 p-1 space-x-1 rounded-xl md:flex space-y-2 md:space-y-0 justify-start md:space-x-2 text-white">
                        <li>
                            <button
                                ...
                                @click="getOrder"
                                class="shadow-md inline-block w-full px-10 py-2 rounded-lg bg-blue-900/20 hover:bg-[#0e9f6e] text-blue-100 hover:text-white ring-white/60 ring-offset-2 ring-offset-blue-400 focus:outline-none focus:ring-2"
                            >
                                All
                            </button>
                        </li>
                        ...
                        <li>
                            <button
                                ...
                                class="shadow-md inline-block w-full px-4 py-2 rounded-lg bg-blue-900/20 hover:bg-[#0066cc] text-blue-100 hover:text-white ring-white/60 ring-offset-2 ring-offset-blue-400 focus:outline-none focus:ring-2"
                            >
                                Delivered
                            </button>
                        </li>
